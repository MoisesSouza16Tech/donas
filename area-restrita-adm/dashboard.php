...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="dashboard.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                        ...
                                        <div class="col mr-2">
                                            <div style="display: flex; align-items: center;">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Total de Donas</div>
                                                <div class="h6 mb-0 font-weight-bold text-gray-800" style="margin-bottom: 4px!important; margin-left: 2px;">
                                                    (<?php echo daoVendedora::contarVendedora() ?>)
                                                </div>
                                            </div>
                                            <div style="display: flex; align-items: center;">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1" style="margin-right: 7px;">
                                                    Bloqueadas
                                                </div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800" style="font-size: 1rem; margin-bottom: 1px!important;">
                                                    <?php echo daoVendedora::contarVendBloq() ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <a class="nav-link" style="padding: 1px;" href="donas.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                                </svg></a>
                                        </div>
                                    </div>
                            ...
                            <div class="card-dashboard card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a class="nav-link" style="padding: 1px;" href="contas.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                                </svg></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div style="display: flex; align-items: center;">
                                                ...
                                                <div class="h6 mb-0 font-weight-bold text-gray-800" style="margin-bottom: 4px!important; margin-left: 5px;">
                                            ...
                                            <div style="display: flex; align-items: center;">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800" style="font-size: 1rem; margin-bottom: 2.2px!important;">
                                                    <?php echo daoVendedora::contarVendBloq() ?>
                                                </div>
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1" style="margin-right: 7px;">
                                                    Clientes
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card-dashboard card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">Denúncias
                                        (<?php echo daoDenuncia::contarDenuncia() ?>)
                                    </h6>
                                </div>
                                    ...
                                    <?php foreach ($ultimasDenuncias as $denuncia) : ?>
                                        ...
                                        <a href="ver-mais-denu.php?id=<?php echo $denuncia['idDenuncia']; ?>">
                                            <div class="customer-wrapper">
                                                <img class="rounded-circle imageDenun" src="../<?php echo $denuncia['fotoCliente'] ?>" alt="">
                    ...
                    <div class="row equal-height-row">
                        ...
                        <div class="col-lg-6 mb-4" style="margin-bottom: 0px!important;">
                            <div class="card-dashboard card shadow mb-4">
                                <div class="card-header py-3">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div>
                                                                <img src="../<?php echo $d['fotoCategoria'] ?>" class="avatar avatar-sm me-3" alt="user5">
                                                            </div>
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="text-sm">
                    ...
                    foreach ($graficodenun as $denuncia) {
                        ...
                        switch ($denuncia['motivoDenuncia']) {
                            ...
                            case 6:
                                ...
                                break;
                            case 7:
                                $motivoDenunciaLabel = 'Problemas com encomenda ou serviço';
                                break;
                            case 8:
                                $motivoDenunciaLabel = 'Pagamento realizado, mas não recebido';
                                break;
                            case 9:
                                $motivoDenunciaLabel = 'Pedido cancelado após o pagamento';
                                break;
                            case 10:
                                $motivoDenunciaLabel = 'Pedido não entregue';
                                break;
                            case 11:
                                $motivoDenunciaLabel = 'Produto danificado ou com defeito';
                                break;
                            case 12:
                                $motivoDenunciaLabel = 'Atraso na entrega';
                                break;
                            case 13:
                                $motivoDenunciaLabel = 'Produto incorreto recebido';
                                break;
                            case 14:
                                $motivoDenunciaLabel = 'Mau atendimento';
                                break;
                            case 15:
                                $motivoDenunciaLabel = 'Problemas com reembolso';
                                break;
                            case 16:
                                $motivoDenunciaLabel = 'Outro motivo';
                                break;
                            default:
    ...
    <script>
        ...
        function drawChart() {
            ...
            ]; // Adicionando o tooltip como uma terceira coluna
