						...
						<li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                ?>
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="ver-mais-denu.php?id=<?php echo $denunciaNot['idDenuncia']; ?>" style="<?php echo $style; ?>" onmouseover="this.style='<?php echo $hoverStyle; ?>'" onmouseout="this.style='<?php echo $style; ?>'">
                                        <div class="mr-3">
                                            <div class="icon-circle bg-primary">
                                                <img class='rounded-circle imageDenunNot' src='../<?php echo $denunciaNot['fotoCliente'] ?>' alt=''>
                                            </div>
                                        </div>
                                        <div>
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h3 class="h3 mb-0 text-gray-800">
							...
							<?php
							$nomeCompleto = $denuncia['nomeCliente'];
