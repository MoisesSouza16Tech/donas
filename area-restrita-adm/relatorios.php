...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" >
                <a class="nav-link d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="relatorios.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div id="linhaTexto" style="width: auto!important;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                ...
                                                <p style="text-align: center;margin-bottom: 0px;">Total pedidos</p>
                                            </div>
                                            <div
                                                ...
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        ...
                                                        <?php echo daoPedidoProduto::contarPedidosTotalEsteAnoAdm() ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                style="font-size: 0.96rem; margin-left: 0px;">
                                                <p style="text-align: center;margin-bottom: 0px;">Pedidos concluídos</p>
                                            </div>
                                            <div
                                                class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        style="margin-right: 0rem !important;">
                                                        <?php echo daoPedidoProduto::contarPedidosEsteAnoAdm() ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                ...
                                <div class="card-body"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                style="font-size: 0.96rem; margin-left: 0px;">
                                                <p style="text-align: center;margin-bottom: 0px;">Total serviços</p>
                                            </div>
                                            <div
                                                class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        style="margin-right: 0rem !important;">
                                                        <?php echo daoPedidoServico::contarPedidosTotalEsteAnoAdm() ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                ...
                                <div class="card-body"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                style="font-size: 0.96rem; margin-left: 0px;">
                                                <p style="text-align: center;margin-bottom: 0px;">Serviços concluídos
                                                </p>
                                            </div>
                                            <div
                                                class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        style="margin-right: 0rem !important;">
                                                        <?php echo daoPedidoServico::contarPedidoEsteAnoAdm() ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                ...
                                <div class="card-body"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                style="font-size: 0.96rem; margin-left: 0px;">
                                                <p style="text-align: center;margin-bottom: 0px;">Hoje</p>
                                            </div>
                                            <div
                                                class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        style="margin-right: 0rem !important;">
                                                        <?php echo daoPedidoProduto::consultaLucroAdmHoje() ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                ...
                                <div class="card-body"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                style="font-size: 0.96rem; margin-left: 0px;">
                                                <p style="text-align: center;margin-bottom: 0px;">Essa semana</p>
                                            </div>
                                            <div
                                                class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        style="margin-right: 0rem !important;">
                                                        R$
                                                        <?php echo daoPedidoProduto::consultaLucroAdmSemana() ?>
                                ...
                                <div class="card-body"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                style="font-size: 0.96rem; margin-left: 0px;">
                                                <p style="text-align: center;margin-bottom: 0px;">Esse mês</p>
                                            </div>
                                            <div
                                                class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        style="margin-right: 0rem !important;">
                                                        R$
                                                        <?php echo daoPedidoProduto::consultaLucroAdmMes() ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                ...
                                <div class="card-body"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
                                                style="font-size: 0.96rem; margin-left: 0px;">
                                                <p style="text-align: center;margin-bottom: 0px;">Esse ano</p>
                                            </div>
                                            <div
                                                class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
                                                        style="margin-right: 0rem !important;">
                                                        R$
                                                        <?php echo daoPedidoProduto::consultaLucroAdmAno() ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div id="linhaTexto" style="width: auto!important;">
                            <h1 class="h3 mb-0 text-gray-800">Usuários destaque</h1>
                        </div>
                    ...
                    <div class="row equal-height-row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card-dashboard card shadow mb-4">
                                <div class="card-header py-3" style="margim-bottom: 0px;">
                                    <h6 class="m-0 font-weight-bold text-success">Top 5 Vendedoras</h6>
                                </div>
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <?php
                                            $donas = daoVendedora::listarTop5();
                                            $contador = 1;
                                            foreach($donas as $d) {
                                            $nomeCompleto = $d['nomeVendedora'];
                                            $partesNome = explode(' ', $nomeCompleto);
                                            $primeiroNome = $partesNome[0];
                                            $segundoNome = isset($partesNome[1]) ? $partesNome[1] : '';
                                                $dataFormatada = date('m/Y', strtotime($d['dataCadastro']));
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <b style="    color: #971881;margin-right: 2px;">
                                                                <?php echo $contador; ?>º
                                                            </b>
                                                            <div>
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="text-sm">
                                                                <?php echo $primeiroNome.' '.$segundoNome; ?>
                                                                </h6>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p class="text-xs text-secondary mb-0">Desde <?php echo $dataFormatada; ?>
</p>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card-dashboard card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">Top 5 Clientes
                                    </h6>
                                </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase lista">Entrou</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $clientetop = daoCliente::listarTop5Clientes();
                                            $contador = 1;

                                            foreach($clientetop as $d) {
                                                $nomeCompleto = $d['nomeCliente'];
                                                $partesNome = explode(' ', $nomeCompleto);
                                                $primeiroNome = $partesNome[0];
                                                $segundoNome = isset($partesNome[1]) ? $partesNome[1] : '';
                                                $dataFormatada = date('m/Y', strtotime($d['dataCadastro']));
