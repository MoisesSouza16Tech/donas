...
/*
$status = daoVendedora::consultarStatus($Vendedora);

// Verifica se a vendedora está desbloqueada (status igual a 1)
if ($status == 1) {
	// Faz a consulta SQL
	$sql = "SELECT * FROM tbVendedora";
	...
	if ($resultado) {
		...
		while ($linha = mysqli_fetch_assoc($resultado)) {
			// Aqui você pode fazer o que quiser com os dados, por exemplo, imprimir na tela
			echo "ID: " . $linha['idVendedora'] . "<br>";
			// Adicione aqui outros campos que você deseja exibir

			echo "<br>";
		}

		// Liberando os recursos do resultado
	...
	echo "A vendedora está bloqueada.";
}
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item active">
				<a class="nav-link d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="donas.php">
					<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
							...
							<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
								...
								foreach($ultimasDenuncias as $denuncia):
									...
									<a class="dropdown-item d-flex align-items-center"
										href="ver-mais-denu.php?id=<?php echo $denuncia['idDenuncia']; ?>"
				...
				<div class="container-fluid">
					...
					<div class="row"
						style="margin-bottom: 0.4rem;align-content: space-between; padding: 0 24px 0 24px;">


						<div class="col-xl-3 col-md-6 mb-4" style="margin-bottom: .6rem !important;">
							<div class="card-dashboard card border-left-success shadow h-100 py-2">
								<div class="card-body"
									style="padding-top: 0; padding-right: 1.25rem; padding-bottom: 0; padding-left: 1.25rem;">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2 ">
											<div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
												style="font-size: 0.96rem; margin-left: 0px;">
												<p style="text-align: center;margin-bottom: 0px;">Total de Donas</p>
											</div>
											<div
												class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
												<div class="col-auto">
												...
												<div class="col" style="
">
													<div class="progress progress-sm mr-2" style="
">
														<div class="progress-bar bg-info" role="progressbar"
															style="width: 100%;background-color: #971881 !important;"
								...
								<div class="card-body"
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2 ">
											<div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
												style="font-size: 0.96rem; margin-left: 0px;">
												<p style="text-align: center;margin-bottom: 0px;">Plano Premium</p>
											</div>
											<div
												class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
												<div class="col">
													<div
														...
														<div class="col-auto">
															<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
																style="margin-right: 0rem !important;">
																<?php $result = daoVendedora::contarVendedoraPremium(); ?>
																<?php echo $result['percentage'].'%'.' ('.$result['countPremium'].')' ?>
															</div>
														</div>
														<div class="col">
															<div class="progress progress-sm mr-2">
																<div class="progress-bar bg-info" role="progressbar"
																	style="width: <?php echo $result['percentage']; ?>%;background-color: #971881 !important;"
								...
								<div class="card-body"
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2 ">
											<div class="text-xs font-weight-bold text-success text-uppercase mb-1 text-align-center"
												style="font-size: 0.96rem; margin-left: 0px;">
												<p style="text-align: center;margin-bottom: 0px;">Plano Comum</p>
											</div>
											<div class="col">
												<div
													class="row no-gutters align-items-center stats-faturamento d-flex flex-column justify-content-center align-items-center">
													<div class="col-auto">
														<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"
															style="margin-right: 0rem !important;">
															<?php $result = daoVendedora::contarVendedoraGratis(); ?>
															<?php echo $result['percentage'].'%'.' ('.$result['countGratis'].')' ?>
														</div>
													</div>
													<div class="col">
														<div class="progress progress-sm mr-2">
...
">
											<input type="text" class="form-control bg-light border-0 small"
												id="searchInput" placeholder="Procurar dona...." aria-label="Search"
	...
	<option value="2">Bloqueado</option>
										...
										<script>
											function aplicarFiltros2() {
												var statusFilter = parseInt(document.getElementById("status").value);
												var tableRows = document.querySelectorAll(".table tbody tr");

												tableRows.forEach(function (row) {
													var statusCell = row.querySelector(".text-uppercase.lista:nth-child(5)");

													if (statusFilter === 0) {
														row.style.display = ""; // Show all rows when no filter selected or "Todos" selected
													} else {
														var rowStatus = statusCell.textContent.toLowerCase();

														if ((statusFilter === 1 && rowStatus.includes("desbloqueada")) ||
															(statusFilter === 2 && rowStatus.includes("bloqueada"))) {
										...
										<table class="table align-items-center mb-0">
											<thead>
												<tr>
													...
													<th class="text-uppercase lista">Alterar Status</th>
													<th class="text-uppercase lista">Ver Perfil</th>
												</tr>
											</thead>
											<tbody>
												<?php
                ...
                <path d="m10.273 2.513-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636a2.89 2.89 0 0 1 4.134 0l-.715.698a1.89 1.89 0 0 0-2.704 0l-.92.944-1.32-.016a1.89 1.89 0 0 0-1.911 1.912l.016 1.318-.944.921a1.89 1.89 0 0 0 0 2.704l.944.92-.016 1.32a1.89 1.89 0 0 0 1.912 1.911l1.318-.016.921.944a1.89 1.89 0 0 0 2.704 0l.92-.944 1.32.016a1.89 1.89 0 0 0 1.911-1.912l-.016-1.318.944-.921a1.89 1.89 0 0 0 0-2.704l-.944-.92.016-1.32a1.89 1.89 0 0 0-1.912-1.911l-1.318.016z"></path>
														...
														<form method="POST" id="form-subcategoria"
															action="../api/dona/alterarStatus.php"
															onsubmit="showModal(event)" data-bs-toggle="modal"
														...
														<td class="align-middle text-center" style="text-align: center;">
															<a
																href="ver-profile-dona.php?id=<?php echo $d['idVendedora']; ?>">
																<svg xmlns="http://www.w3.org/2000/svg" width="25"
																	height="25" fill="currentColor" class="bi bi-zoom-in"
																	viewBox="0 0 16 16">
																	<path fill-rule="evenodd"
